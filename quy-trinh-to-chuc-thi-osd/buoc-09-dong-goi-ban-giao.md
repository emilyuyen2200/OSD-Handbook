---
description: >-
  Đóng gói, niêm phong, lưu trữ và bàn giao toàn bộ bài thi cho đơn vị vận
  chuyển sau khi hoàn tất kỳ thi, đảm bảo hồ sơ được sắp xếp đúng quy định và
  gửi về ÖSD an toàn, đúng hạn.
layout:
  width: wide
  title:
    visible: true
...
* Theo dõi lộ trình vận chuyển đến khi ÖSD xác nhận đã nhận hàng; xử lý phát sinh (chậm, thất lạc) theo [Danh mục rủi ro & phương án xử lý](/broken/pages/vuSkrIGh1UJgIvYrqnKI) nếu có.
{% endstep %}
{% endstepper %}
...
* Nếu lô hàng chậm hoặc thất lạc trong vận chuyển, xem [Danh mục rủi ro & phương án xử lý](/broken/pages/vuSkrIGh1UJgIvYrqnKI).
{% endhint %}
...
{% content-ref url="buoc-10-cong-bo-ket-qua.md" %}
