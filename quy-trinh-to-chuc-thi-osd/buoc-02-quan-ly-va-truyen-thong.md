...
<p align="center">2A: <a href="/broken/pages/qwZS8hnouW3dRzcVRl3p">Exam Coordinator</a></p>

<p align="center">2B: <a href="/broken/pages/J17vcKnUfM2dVmTo2jc2">Phòng Marketing</a></p>
{% endcolumn %}

{% column width="33.33333333333333%" %}
<h4 align="center">✅ <strong>Phê duyệt</strong></h4>

<p align="center"><a href="/broken/pages/eNKAY8zUuZpklDTzVZGk">Exam Director</a></p>
{% endcolumn %}
{% endcolumns %}
...
| Vai trò                                                | Trách nhiệm                                                                             |
| ------------------------------------------------------ | --------------------------------------------------------------------------------------- |
| [Exam Coordinator](/broken/pages/qwZS8hnouW3dRzcVRl3p) | Quản lý đăng ký, xử lý hồ sơ, đối soát thanh toán và lập danh sách thí sinh chính thức. |
{% endcolumn %}

{% column %}
<table><thead><tr><th width="141.9296875">Vai trò</th><th>Trách nhiệm</th></tr></thead><tbody><tr><td><a href="/broken/pages/J17vcKnUfM2dVmTo2jc2">Phòng Marketing</a></td><td>Triển khai truyền thông và theo dõi hiệu quả đăng ký.</td></tr></tbody></table>
{% endcolumn %}
{% endcolumns %}
