...
[buoc-07-to-chuc-ky-thi/README.md](02-processes/buoc-07-to-chuc-ky-thi/README.md)
{% endcontent-ref %}
...
{% content-ref url="03-roles/exam-operations-team/README.md" %}
[exam-operations-team.md](03-roles/exam-operations-team/README.md)
{% endcontent-ref %}
...
> 📌 Muốn hiểu cách handbook này được tổ chức (quy ước đặt tên, metadata...)? Xem [Hệ thống](https://github.com/emilyuyen2200/OSD-Operation).
